        ...
        <div className="h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex-grow max-w-md relative group">
            <Input 
              ...
              className="w-full bg-secondary/50 border-none h-9 pl-10 pr-20 focus-visible:ring-primary focus-visible:bg-secondary transition-all rounded-full text-xs"
            />
            <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-focus-within:text-primary transition-colors" />
            <Button className="absolute right-0 top-0 h-9 rounded-r-full px-4 bg-primary text-background hover:bg-primary/90 font-bold text-[10px] uppercase">
              Search
            </Button>
          </div>

          {/* Navigation Links - Now beside search bar */}
          <div className="hidden lg:flex items-center gap-6 shrink-0">
            <ul className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
              <li>
