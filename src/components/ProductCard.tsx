          ...
          <div className="mt-auto pt-0.5">
            <div className="flex flex-col justify-start mb-1 md:mb-2 relative">
              <div className="flex items-baseline gap-0.5 text-black">
                <span className="text-[8px] md:text-[11px] font-black text-primary">৳</span>
                <span className="font-black text-[14px] md:text-[20px] tracking-tighter leading-none">
              ...
              <div className="flex items-center justify-between h-[12px] md:h-[16px]">
                {originalPrice > price ? (
                  <>
                    <p className="text-[8px] md:text-[10px] text-black/60 line-through font-bold tracking-tight">
