  ...
  return (
    <div className="min-h-screen flex flex-col bg-background selection:bg-[#01a3a4]/30">
      ...
      <main className="flex-grow container mx-auto py-0 space-y-12">
        {/* HERO SECTION - FULL WIDTH WITH 420PX HEIGHT */}
            ...
            <div className="bg-[#01a3a4] h-2/3 p-10 flex flex-col items-center justify-center space-y-10 shadow-inner">
              ...
              <div className="w-full space-y-5">
                <div className="flex items-center gap-5">
                  <div className="w-14 h-14 bg-black/10 flex items-center justify-center border border-white/20 shrink-0">
                    <Truck className="h-7 w-7 text-white" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-white/80 font-black text-[10px] uppercase tracking-widest leading-none mb-1">FREE</span>
                    <span className="text-white font-black text-[18px] uppercase tracking-tighter">DELIVERY</span>
                  </div>
                </div>
                <div className="flex items-center gap-5">
                  <div className="w-14 h-14 bg-black/10 flex items-center justify-center border border-white/20 shrink-0">
                  ...
                  <div className="flex flex-col">
                    <span className="text-white/80 font-black text-[10px] uppercase tracking-widest leading-none mb-1">LIMITED</span>
                    <span className="text-white font-black text-[18px] uppercase tracking-tighter">TIME</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="bg-card/20 p-10 border-y border-white/5 mx-0">
          <div className="flex items-center justify-between mb-12">
            <div className="flex items-center gap-5">
              <div className="h-12 w-2.5 bg-[#01a3a4]" />
              <h2 className="text-4xl font-black flex items-center gap-4 uppercase tracking-tighter text-white">
                <Flame className="h-10 w-10 text-[#01a3a4] fill-current" /> TOP SELLING
              </h2>
            </div>
        ...
        <section className="space-y-12 pb-24 px-10">
          <div className="flex items-center gap-5">
            <div className="h-10 w-2.5 bg-[#01a3a4]" />
            <h2 className="text-4xl font-black uppercase tracking-tighter text-white">SYSTEM CATEGORIES</h2>
          </div>
