          ...
          <div className="col-span-3 h-full bg-primary relative overflow-hidden flex flex-col items-center justify-center p-1 md:p-4 space-y-1 md:space-y-4 gpu-accelerated shadow-[inset_0_0_100px_rgba(0,0,0,0.2)]">
            {settings?.showVideoInAppBar ? (
              ...
              <div className="flex flex-col items-center justify-center space-y-2 md:space-y-4 relative z-10">
                <h3 className="text-white font-black text-[6px] md:text-sm lg:text-lg uppercase tracking-[0.2em] italic text-center drop-shadow-xl font-headline">DOWNLOAD OUR APP</h3>
                <div className="bg-white p-1 md:p-2 w-10 h-10 md:w-28 md:h-28 flex items-center justify-center border border-white/20 shadow-2xl">
                ...
                <div className="flex flex-col gap-0.5 md:gap-2 w-full max-w-[140px]">
                  <button className="w-full bg-white text-black h-5 md:h-8 flex items-center justify-center gap-1 md:gap-2 font-black text-[5px] md:text-[9px] uppercase shadow-lg hover:opacity-90 transition-all"><Apple className="h-2 w-2 md:h-4 md:w-4" /> APP STORE</button>
                  <button className="w-full bg-white text-black h-5 md:h-8 flex items-center justify-center gap-1 md:gap-2 font-black text-[5px] md:text-[9px] uppercase shadow-lg hover:opacity-90 transition-all"><Play className="h-2 w-2 md:h-4 md:w-4" /> PLAY STORE</button>
                </div>
              </div>
            )}
          </div>
