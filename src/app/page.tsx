      ...
      <main className="flex-grow container mx-auto py-0 space-y-4">
        <section className="grid grid-cols-12 gap-0 h-[420px] max-h-[420px] overflow-hidden">
              ...
              <Carousel className="w-full h-full" opts={{ loop: true }} plugins={[plugin.current]}>
                <CarouselContent className="h-[420px]">
                  {combinedSliderItems.map((item, index) => (
                    <SlideItem key={item.id || index} item={item} priority={index < 2} />
                  ))}
                </CarouselContent>
              </Carousel>
            ) : (
          ...
          <div className="col-span-3 flex flex-col h-[420px] bg-[#01a3a4] overflow-hidden">
            <div className="h-full p-10 flex flex-col items-center justify-center space-y-10">
              ...
              <div className="pt-8 flex flex-col items-center gap-6 w-full">
                <div className="bg-white p-2 w-28 h-28 shrink-0 flex items-center justify-center shadow-2xl">
                ...
                <div className="flex flex-col gap-3 w-full max-w-[200px]">
                  <button className="bg-white text-black h-10 px-4 flex items-center gap-4 hover:bg-black hover:text-white border-none w-full shadow-lg transition-colors"><Apple className="h-5 w-5 fill-current" /><span className="text-[11px] font-black uppercase tracking-widest">APP STORE</span></button>
                  <button className="bg-white text-black h-10 px-4 flex items-center gap-4 hover:bg-black hover:text-white border-none w-full shadow-lg transition-colors"><Play className="h-5 w-5 fill-current" /><span className="text-[11px] font-black uppercase tracking-widest">GOOGLE PLAY</span></button>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="relative w-full aspect-square overflow-hidden group-hover:ring-2 group-hover:ring-[#01a3a4] transition-all bg-black shadow-2xl">
                    {cat.imageUrl && (
                      <Image 
                        ...
                        quality={70} 
                        className="object-cover group-hover:scale-110 opacity-90" 
                      />
                    )}
                  </div>
