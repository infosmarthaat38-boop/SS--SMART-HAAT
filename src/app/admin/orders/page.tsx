...
export default function AdminOrders() {
  ...
  const generateInvoice = async (order: any) => {
    ...
    doc.text("SS SMART HAAT MARKET PLACE", 15, 25);
    ...
    doc.text("THANK YOU FOR CHOOSING SS SMART HAAT MARKET PLACE. YOUR SATISFACTION IS OUR PRIORITY.", 15, 282);
    doc.text("GENERATED BY SS SMART HAAT MARKET PLACE SYSTEM", 135, 282);
